...
export default function SiteFooter() {
  ...
  return (
    <footer className="relative border-t border-white/10 bg-ink pb-8 pt-16">
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 sm:px-8 md:grid-cols-3">
        ...
        <div className="flex flex-col items-center text-center md:items-start md:text-left">
          <div className="flex items-center gap-3">
            ...
            <img
              ...
              width={56}
              height={56}
              className="h-14 w-14 shrink-0 rounded-full border-2 border-cream bg-white object-contain p-1"
            />
            <div className="text-left">
              <p className="font-serif text-3xl leading-none text-cream">
                {site.name}
              </p>
          ...
          <p className="mt-5 max-w-sm text-sm text-cream-muted">
        ...
        <div className="flex flex-col items-center text-center">
          <ul className="grid grid-cols-2 gap-x-10 gap-y-3 font-serif text-lg text-cream-muted">
            {navLinks.map((l) => (
              <li key={l.href}>
                <Link
                  href={l.href}
        ...
        {/* Location + socials */}
        <div className="flex flex-col items-center text-center">
          <address className="font-serif text-lg not-italic leading-relaxed text-cream">
            {site.location}
          </address>
      ...
      {/* Bottom bar */}
      <div className="mx-auto mt-16 flex max-w-7xl flex-col-reverse items-center justify-between gap-3 border-t border-white/10 px-5 pt-6 text-center text-xs uppercase tracking-[0.25em] text-cream-muted sm:px-8 md:flex-row md:items-center md:text-left">
